...
export const metadata = {
  ...
  description:
    "Reserva campings, glampings y hoteles en España. Ofertas en montaña: Pirineos, Picos de Europa, Sierra Nevada y más.",
};
    ...
    <>
      <section className="relative border-b border-brand-forest/20 px-4 py-12 text-white sm:px-6 lg:px-8">
        <div className="absolute inset-0 overflow-hidden">
          <Image
            src="/offers/camping-vidra-hero.png"
            alt="Camping Vidrà en la montaña"
            fill
            priority
